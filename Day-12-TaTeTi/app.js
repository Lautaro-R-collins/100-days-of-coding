...
function gameOver(a) {
    let gameOverAlert = "<b>Juego Terminado </b><br><br> Player " + span[a].dataset.player.toUpperCase() + ' Es el ganador !!! <br><br>' + restartButton;
...
function draw() {
    let drawAlert = '<b>Es un Empate!!!</b><br><br>' + restartButton;
    let div = document.createElement("div");
    div.className = "alert";
